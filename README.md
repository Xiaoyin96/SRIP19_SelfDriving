...
+ [maskrcnn-video](./maskrcnn-video): Using I3D video input as backbone to extract glob features and roi features with feature selector, performing end-to-end training.
